...
import lane_detect_data_processor
...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    train_dataset = lane_detect_data_processor.DataSet(train_dataset_file)
    val_dataset = lane_detect_data_processor.DataSet(val_dataset_file)
    # 输入张量占位
    ...
    # 网络定义
    net = lane_detect_merge_model.LaneNet(net_flag=net_flag, phase=phase)
