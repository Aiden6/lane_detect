...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 14:57:48 2018
...
class CNNBaseModel(object):
    ...
    #dw stride in width
    #p 参数列表
    #use_biases use biases wether or not
    @staticmethod
    ...
    def layernorm(inputdata, epsilon=1e-5, use_bias=True, use_scale=True,
        ...
        #get the dimension of inputdata
        ndims = len(shape)
        assert ndims in [2, 4]
    ...
    def layerbn(inputdata, is_training, name):
        def f1():
            # print('batch_normalization: train phase')#用于训练阶段
        ...
        def f2():
            # print('batch_normalization: test phase')#用于测试阶段
            return tf_layer.batch_norm(
